...
initial_input_directory="data/CESM2_LE/TREFHT_new/day_raw" # the raw data files as downloaded from the large ensemble
variable1="TREFHT"
# 1 TREFHT
...
## INPUT: data/TREFHT/5daily_TREFHT
## OUTPUT: data/TREFHT/5daily_TREFHT_subset
...
## PYTHON SCRIPT: data_preprocessing/restructured_modularized/combine_TREFHT_LE.py
## INPUT: data/TREFHT/5daily_TREFHT_subset
## OUTPUT: data/TREFHT/5daily_TREFHT_combined_JJA
...
## 1.5) mask data
## PYTHON SCRIPT: data_preprocessing/restructured_modularized/apply_land_mask_TREFHT.py
## INPUT: data/TREFHT/5daily_TREFHT_combined_JJA/stacked_TREFHT_JJA.nc
## OUTPUT: data/TREFHT/5daily_TREFHT_combined_JJA/europe_10percent_masked_stacked_TREFHT_JJA.nc
