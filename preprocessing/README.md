...
- CESM2 ETH-Ensemble (in parts): https://zenodo.org/records/18172330 or upon request
- CESM2 ERA5-nudged: upon request from https://github.com/niklas1347/Overview_nudgedClimateSimulations
- ERA5 data: https://cds.climate.copernicus.eu/datasets

All paths need to be adjusted to your personal file structure.
