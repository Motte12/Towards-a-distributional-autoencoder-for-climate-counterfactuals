...
###################################
parent_directory="data/ERA5/Z500/Z500_not_detrended/"
initial_input_directory="data/ERA5/daily/geopot500hpa/"
#variable1="Z500"
...
file_pre="${output1}E5sf00_1D_geopotheight500hpa_1940-2025_remapped_to_CESM2.nc" 
...
python data_preprocessing/restructured_modularized/Z500_preprocessing/ETH_Z500_preprocessing/EOF_calculation_ETH_Z500.py \
    --input_dir "${output2}" \
    --output_dir "${output3}" \
    --input_le_z500 "data/automated_preprocessing_13012025/Z500/temporary2" \
    --compute_eofs_new 1 \
    --project_eth_data 0 \
    --variable "var129" \
    --project_ERA5 1 \
