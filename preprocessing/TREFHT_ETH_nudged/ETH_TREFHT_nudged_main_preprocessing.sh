...
###################################
parent_directory="data/automated_preprocessing_13012025/TREFHT_ETH/ETH_nudged/"
initial_input_directory="data/TREFHT/ETH_ensemble/daily_nudged_shifted"
variable1="TREFHT"
...
## PYTHON SCRIPT: ETH_TREFHT_preprocessing/combine_TREFHT_ETH_nudged_shifted.py
