...
#SBATCH --output=/home/sc.uni-leipzig.de/fl53wumy/llaae_new/TowardsDistributionalAutoencoderClimateCounterfactuals/tuning/tuning8/out/slurm-%A_%a.out
#SBATCH --error=/home/sc.uni-leipzig.de/fl53wumy/llaae_new/TowardsDistributionalAutoencoderClimateCounterfactuals/tuning/tuning8/err/slurm-%A_%a.err
...
STATUS_DIR=/home/sc.uni-leipzig.de/fl53wumy/llaae_new/TowardsDistributionalAutoencoderClimateCounterfactuals/tuning/tuning8/status
mkdir -p "$STATUS_DIR"
...
~/.conda/envs/dpa/bin/python ../../src/modeling/train_joint_dae.py \
    --settings_file tune_settings.json \
    --epochs 100 \
    --encoder "$enc" \
    --in_dim 648 \
    --latent_dim "$ld" \
